...
Both projects use an `employee\_system` package containing employee-related modules.
...
The `employee\_system` package contains:
...
from employee\_system.employee import get\_all\_employees
